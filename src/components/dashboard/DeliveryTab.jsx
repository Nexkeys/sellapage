...
import { Truck, Save, Check, AlertCircle, Globe, Lock } from "lucide-react";
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">
            Manage your delivery settings and prepare for Shipbubble
            integration.
          </p>
        </div>
      </div>
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-400 text-xs mt-0.5">
              This is where your orders will be shipped from.
            </p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 relative">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-400 text-xs mt-0.5">
              Add specific delivery zones and prices. Available for Pro and
              Premium vendors.
            </p>
          </div>
        </div>
          ...
          <div className="absolute inset-0 bg-white/80 flex items-center justify-center rounded-2xl">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-700 font-semibold">
                Delivery Zones are a Pro feature
              </div>
              <div className="text-xs text-gray-500 mt-1">
                Upgrade to Pro to manage delivery zones.
              </div>
            </div>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
          ...
          <div className="sm:col-span-2 flex items-center gap-2">
            ...
            {zonesError && (
              <div className="text-sm text-red-600">{zonesError}</div>
            )}
          </div>
        </div>
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
          {(zones || []).map((z) => (
            <div
              key={z.id}
              className="border border-gray-100 rounded-xl p-3 flex justify-between items-start"
            >
              <div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-400 text-xs mt-0.5">
              View orders with Shipbubble tracking IDs.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-3">
          {(orders || [])
            .filter((o) => o.shipbubbleTrackingId)
            .map((o) => (
              <div
                key={o.id || o.orderId || o.shipbubbleTrackingId}
              ...
              >
                <div>
                  ...
                  <div className="text-xs text-gray-500">
                    Tracking ID: {o.shipbubbleTrackingId}
                  </div>
                  <div className="text-xs text-gray-500">
                    Status: {o.shipbubbleStatus || "Unknown"}
                  </div>
                </div>
                <div>
                  <a
                    href={`https://tracking.shipbubble.com/${o.shipbubbleTrackingId}`}
                    target="_blank"
                    rel="noreferrer"
