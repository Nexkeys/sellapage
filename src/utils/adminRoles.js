...
const TAB_ACCESS = {
  ...
  'ai-describe': [ADMIN_ROLES.SUPER_ADMIN],
  sms: [ADMIN_ROLES.SUPER_ADMIN, ADMIN_ROLES.MARKETING],
  ...
  email: [ADMIN_ROLES.SUPER_ADMIN, ADMIN_ROLES.MARKETING],
  marketplace: [ADMIN_ROLES.SUPER_ADMIN, ADMIN_ROLES.OPERATIONS],
}
