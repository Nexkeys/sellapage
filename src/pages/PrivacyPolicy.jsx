...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      'Dropshipped orders: When you buy a product that a store sells through the Sellapage Dropshipping Marketplace, we share your name, phone number and delivery address with the partner who fulfils that order, only so they can deliver it. They are bound by a written agreement to use it for nothing else, keep it secure, and delete it within 90 days after delivery.',
