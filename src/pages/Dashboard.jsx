...
export default function Dashboard() {
  ...
  const fetchLeads = async () => {
    ...
    try {
      ...
      // Filter to only this store's leads
  ...
  // Handle adding new image files (up to 3 total)
  ...
  // Remove an already-uploaded image (stored in Firestore)
  ...
  // Remove a new (not yet uploaded) image preview
