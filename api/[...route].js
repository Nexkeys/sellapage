...
export default async function handler(req, res) {
  try {
    ...
    switch (endpoint) {
      ...
      case "admin-email": {
        const { default: handler } = await import("../src/api-handlers/admin-email.js")
        return handler(req, res)
      }
      case "email-broadcast-cron": {
        const { default: handler } = await import("../src/api-handlers/email-broadcast-cron.js")
        return handler(req, res)
      }
      case "email-unsubscribe": {
        const { default: handler } = await import("../src/api-handlers/email-unsubscribe.js")
        return handler(req, res)
      }
      ...
      case "order-track": {
        const { default: handler } = await import("../src/api-handlers/order-track.js")
        return await handler(req, res)
      }
      case "store-design": {
